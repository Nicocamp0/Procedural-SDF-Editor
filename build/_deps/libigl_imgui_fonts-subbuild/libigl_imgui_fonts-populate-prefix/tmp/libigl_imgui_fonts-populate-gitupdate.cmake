...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/bouboune/Documents/Master_1/Géométrie_numérique/geo_num_project/build/_deps/libigl_imgui_fonts-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/bouboune/Documents/Master_1/Géométrie_numérique/geo_num_project/build/_deps/libigl_imgui_fonts-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
