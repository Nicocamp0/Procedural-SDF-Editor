...
```
cd existing_repo
git remote add origin https://git.unistra.fr/ventadoux/geo_num_project.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.unistra.fr/ventadoux/geo_num_project/-/settings/integrations)
...
>>>>>>> cf85428 (added base from previous TP)
